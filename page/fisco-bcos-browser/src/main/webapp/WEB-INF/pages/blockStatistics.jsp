...
<div class="wrapper">
    ...
    <div class="breadcrumbs">
        <div class="container">
            <h1 class="pull-left">共识流<span class="lead-modify" style="color: #999999">&nbsp;</span><br />
            </h1>
            <ul class="pull-right breadcrumb">
                <li><a href="../">首页</a></li>
                <li class="active">共识流</li>
            </ul>
        </div>
    </div>
            ...
            <form class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    <label class="col-xs-1 control-label">
                        <button type="button" class="btn btn-info btn-sm" onclick="queryBlockStatisticsList()">查询</button>
                    </label>
                </div>
        </div>
        <div class="row">
...
<script type="text/javascript" src="../js/blockStatistics.js"></script>
