    ...
    <div class="breadcrumbs">
        <div class="container">
            ...
            <ul class="pull-right breadcrumb">
                <li><a href="../">首页</a></li>
                <li><a href="../transaction/transaction.page">交易</a></li>
                ...
                <div class="tab-pane fade in active" id="overview">
                    <div class="panel panel-info">
                        ...
                        <div id="ContentPlaceHolder1_maintable" class="container row" style="margin-top:30px">
                            ...
                            <div class="col-sm-12">
                                交易回执信息：
                                <pre id="resultTransactionReceiptDetail"></pre>
                            </div>
                        </div>
                        <div>
                        </div>
...
<script type="text/javascript">
    ...
    //获取交易详细信息
    $.ajax({
        url:'../transaction/getTbTransactionByPkHash.json',//URI
    ...
    //获取交易回执详细信息
    $.ajax({
        url:'../transactionReceipt/getTbTransactionReceiptByPkHash.json',//URI
        contentType:"application/json;charset=UTF-8",//设置头信息
        type:'post',
        cache:false,
        dataType:'json',
        ...
        success:function(DATA) {
            if(DATA.status==0){
                //显示json
                var jsonStr = JSON.stringify(DATA.data, null, 2);
                $('#resultTransactionReceiptDetail').html(jsonStr);
            }else {
                console.log("query fail:"+DATA);
                alert("query fail:"+DATA.msg);
            }
